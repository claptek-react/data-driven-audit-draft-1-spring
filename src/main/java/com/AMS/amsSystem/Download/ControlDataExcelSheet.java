...
public class ControlDataExcelSheet {

	
	public static void ControlExcel(List<ControlData> list, String filename) throws SQLException, IOException {
		
		
		
		   XSSFWorkbook workbook =new XSSFWorkbook();
		   
		   XSSFSheet sheet = workbook.createSheet("Control Data");
		   ...
		   int rowid = 0;
		    ...
		    row.createCell(13).setCellValue("Object Type");
