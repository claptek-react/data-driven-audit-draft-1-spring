...
//        @Id
		...
		public String getBuisnessCriticality() {
			return buisnessCriticality;
		}

		public void setBuisnessCriticality(String buisnessCriticality) {
			this.buisnessCriticality = buisnessCriticality;
		}
		...
		public ProcessData(String objId, String objTitle, String validFrom, String validUntil, String ownerOrganisation,
				String owner, String level1Approver, String level2Approver, String relationships, String status,
				String category, String buisnessCriticality, String createdOn, String createdBy, String modifiedBy,
				Date modifiedOn, int pId, String instanceId, String approver) {
			super();
			this.objId = objId;
			this.objTitle = objTitle;
			this.validFrom = validFrom;
