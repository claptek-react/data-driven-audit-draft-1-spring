...
@Entity
@Table(name="DD_GRC_TEST_ABC")
public class TestMultirow {
	...
	public TestMultirow(int muABCKey, String objId, String field, String fieldValue) {
		super();
		this.muABCKey = muABCKey;
		this.objId = objId;
		this.field = field;
	...
	public String toString() {
		return "TestMultirow [muABCKey=" + muABCKey + ", objId=" + objId + ", field=" + field + ", fieldValue="
