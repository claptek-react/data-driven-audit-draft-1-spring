...
@Entity
@Table(name="DD_GRC_CONTROL_S")
public class SaveControlData {
	...
	public SaveControlData(String id, String objTitle, String validFrom, String validUntil, String ownerOrganisation,
