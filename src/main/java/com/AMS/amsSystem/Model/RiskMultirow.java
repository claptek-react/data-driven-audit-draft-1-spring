...
@Entity
@Table(name="DD_GRC_RISK_ABC")
public class RiskMultirow {
	...
	public RiskMultirow(int muABCKey, String objId, String field, String fieldValue) {
		super();
		this.muABCKey = muABCKey;
		this.objId = objId;
		this.field = field;
	...
	public String toString() {
		return "RiskMultirow [muABCKey=" + muABCKey + ", objId=" + objId + ", field=" + field + ", fieldValue="
