...
@Entity
@Table(name ="DD_GRC_RISK_S")
public class SaveRiskData {
	...
	public SaveRiskData(String id, String objTitle, String validFrom, String validUntil, String ownerOrganization,
			String owner, String level1Approver, String level2Approver, String relationships, String status,
			String category, String createdOn, String createdBy, String modifiedBy, Date modifiedOn, String pId,
			String instanceId, String approver) {
		super();
		this.id = id;
		this.objTitle = objTitle;
		this.validFrom = validFrom;
